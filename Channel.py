...
class Channel:
    ...
    def calculate_channel_dimensions(self):
        ...
        excavation_vol=self.channel_data["channel length"]*(excavation_width*(foundation_thickness+0.1)+np.power(excavation_width, 2) *\
    ...
    def calculate_channel_material(self):
        if self.channel_material["structural material"]=="RCC":
            channel_rcc =c_rm.Raw_Material(self.channel_dimensions,self.raw_material)
